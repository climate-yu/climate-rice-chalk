...
# 1. 读取数据
data_path = r"C:\Users\27144\Desktop\20240506气候\晚\晚1.xlsx"
...
for z_score_threshold in z_score_thresholds:
    for cv in [4, 7, 10, 15]:
        ...
        # 分割数据集
        X_train, X_test, y_train, y_test = train_test_split(X_filtered, y_cleaned, test_size=0.3, random_state=42)
...
'''# 新数据集的预测
new_data_path = r"D:\\xunlei\\data-xin\\ssp585\\combine\\2100\\ssp585-2100-晚.xlsx"
...
# 输出结果至新的Excel文件
output_path = r"D:\\xunlei\\data-xin\\ssp585\\combine\\2100\\ssp585-2100-晚-预测.xlsx"
