...
# 读取Excel文件的路径保持不变
file_path = r"C:\Users\27144\Desktop\中-days.xlsx"
data = pd.read_excel(file_path)


data['F-M days ≥ 30℃'] = round(data['F-M days ≥ 30℃'], 1)

# 对于每个'F-M TMIN'值，计算'Chalkiness'的平均值和标准差
grouped_data = data.groupby('F-M days ≥ 30℃')['Chalkiness'].agg(['mean', 'std']).reset_index()

x_unique = grouped_data['F-M days ≥ 30℃']
